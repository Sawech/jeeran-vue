<template>
  <div v-if="this.$route.name=='AdminCreate'" class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/categories.html">
          ...
          <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card card-flush py-4">
              ...
              <div class="card-body pt-0">
                <div class="mb-10 fv-row">
                  {{$t('role')}}
                  <select class="form-select"    v-model="form.role_id" name="condition_type" data-placeholder="Select an option" data-kt-ecommerce-catalog-add-category="condition_type">
            ...
            <div class="d-flex justify-content-end">
              <router-link :to="{name: 'Admin'}" class="btn btn-light me-5">
                {{$t('cancel')}}
              </router-link>
...
this.getRoles();
  ...
  methods: {
    ...
    create() {
      this.$axios.post('admin/user/add',this.form)
            .then(response => {
    ...
    getRoles(){
      this.$axios.get('admin/user/roles')
          .then(response => {
