                ...
                <div class="mb-10">
                  ...
                  <div>
                    <select
                      ...
                      data-dropdown-parent="#kt_menu_6205ad357830a"
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
      ...
      <div id="kt_content_container" class="container-xxl">
        ...
        <div class="row gy-5 g-xl-8">
              ...
              <div class="card-body p-0">
                ...
                <div class="card-p mt-n20 position-relative">
                  ...
                  <div class="row g-0">
                    <!--begin::Col-->
                    <div
                      class="col bg-light-info px-6 py-8 rounded-2 me-7 mb-7"
                    >
                      <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                      <span
                        class="svg-icon svg-icon-3x svg-icon-warning d-block my-2"
                      >
                        {{ form.cutCaseOrdersCount }}
                      </span>
                      <!--end::Svg Icon-->
                      <router-link
                        :to="{ name: 'OrderCutCase' }"
                        class="text-warning fw-bold fs-6"
                        >{{ $t("cutCase") }}</router-link
                      >
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                      ...
                      <span
                        class="svg-icon svg-icon-3x svg-icon-primary d-block my-2"
                      >
                        {{ form.sewingCaseOrdersCount }}
                      </span>
                      <!--end::Svg Icon-->
                      <router-link
                        :to="{ name: 'OrderSewingCase' }"
                        class="text-primary fw-bold fs-6"
                        >{{ $t("sewingCase") }}</router-link
                      >
                    </div>
                    <!--end::Col-->
                  </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col bg-light-success px-6 py-8 rounded-2">
                      ...
                      <span
                        class="svg-icon svg-icon-3x svg-icon-danger d-block my-2"
                      >
                        {{ form.readyToDeliverOrdersCount }}
                      </span>
                      ...
                      <router-link
                        ...
                        >{{ $t("ready_to_deliver") }}</router-link
                      >
                    </div>
                    <!--end::Col-->
                  </div>
          ...
          <!--                  <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6205ad35855bb">-->
          <!--                    &lt;!&ndash;begin::Header&ndash;&gt;-->
          <!--                    <div class="px-7 py-5">-->
          <!--                      <div class="fs-5 text-dark fw-bolder">Filter Options</div>-->
          <!--                    </div>-->
          ...
          <!--                        <div>-->
          <!--                          <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6205ad35855bb" data-allow-clear="true">-->
          <!--                            <option></option>-->
          <!--                            <option value="1">Approved</option>-->
          <!--                            <option value="2">Pending</option>-->
          <!--                            <option value="2">In Process</option>-->
        ...
        <!--                            &lt;!&ndash;begin::Svg Icon | path: icons/duotune/general/gen019.svg&ndash;&gt;-->
        <!--                            <span class="svg-icon svg-icon-3">-->
        <!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
        ...
        <!--                          </a>-->
        <!--                          <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">-->
        <!--                            &lt;!&ndash;begin::Svg Icon | path: icons/duotune/art/art005.svg&ndash;&gt;-->
        <!--                            <span class="svg-icon svg-icon-3">-->
        <!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
        ...
        <!--                            &lt;!&ndash;begin::Svg Icon | path: icons/duotune/general/gen027.svg&ndash;&gt;-->
        <!--                            <span class="svg-icon svg-icon-3">-->
        <!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
        ...
        <!--														&lt;!&ndash;begin::Svg Icon | path: icons/duotune/abstract/abs027.svg&ndash;&gt;-->
        ...
        <!--        </div>-->
        <!--        &lt;!&ndash;end::Row&ndash;&gt;-->
        <!--        &lt;!&ndash;begin::Calendar Widget 1&ndash;&gt;-->
        <!--        <div class="card">-->
  ...
  methods: {
    ...
    getDelivered(page = 1) {
      this.$axios
        ...
        .then((response) => {
          if (response.data.code == 200) {
            this.delivered = response.data.data.data;
          }
          if (response.data.code == 202) {
            this.delivered = [];
          }
    ...
    getMonthly() {
      this.$axios.get("admin/dashboard/monthly-orders").then((response) => {
        if (response.data.code == 200) {
          this.monthly = response.data.data;
        }
        if (response.data.code == 202) {
          this.monthly = [];
        }
    ...
    getWeekly() {
      this.$axios.get("admin/dashboard/weekly-orders").then((response) => {
        if (response.data.code == 200) {
          this.weekly = response.data.data;
        }
        if (response.data.code == 202) {
          this.weekly = [];
        }
    ...
    getDaily() {
      this.$axios.get("admin/dashboard/daily-orders").then((response) => {
        if (response.data.code == 200) {
