<template>
  <div v-if="this.$route.name=='CategoriesCreate'" class="content d-flex flex-column flex-column-fluid" id="kt_content">
...
export default {
  ...
  methods: {
    ...
    create() {
      this.$axios.post('admin/category/add',this.form)
            .then(response => {
