<template>
  <div
    v-if="this.$route.name == 'UserCreate'"
              ...
              <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                  ...
                  >
                    ...
                    <option value="3">{{ $t("seller") }}</option>
                    <option value="4">{{ $t("shear_operator") }}</option>
                    <option value="5">{{ $t("sewing_operator") }}</option>
                    <option value="6">{{ $t("button_operator") }}</option>
                  </select>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    create() {
      this.$axios.post("admin/user/add", this.form).then((response) => {
